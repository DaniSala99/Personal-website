...
import CriticalHydrographs from '../../src/components/CriticalHydrographs.astro';
...
- **Pluviometric alert threshold = 80 m³/s**, with corresponding rainfall envelopes derived for three hyetograph types and three AMC classes, operationally usable by a civil protection agency.
