...
*Specific deliverables and client outputs remain confidential under NDA. Methodology available for discussion under mutual NDA.*
...
**Skills demonstrated:** CSRD-aligned climate risk methodology · physical risk modeling for energy assets · climate scenario analysis · ESG reporting workflows · global portfolio analytics.

*All client data, portfolio specifics and output metrics confidential under NDA.*
...
ENAC A1/A3 UAS Operator Certificate (Open Category)
Italian (native) · English (C1) · Spanish (B2)
